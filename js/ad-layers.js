...
AdLayersAPI = function() {
	...
	if (
		'string' === typeof adLayersAdServer.jsAPIClass
		&& 'AdLayersAPI' !== adLayersAdServer.jsAPIClass // prevents infinite loop.
		&& 'function' === typeof window[ adLayersAdServer.jsAPIClass ]
	) {
...
AdLayersAPI.prototype.refreshAll = function( args ) {
	if ( this.functionExists( 'refreshAll' ) ) {
		this.adServer.refreshAll( args );
	}
}
